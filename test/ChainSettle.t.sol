...
/// @author Uttam Singh
/// @notice ChainSettle tests
contract ChainSettleTest is Test {
    /// @notice Cheatcodes
    Vm internal VM;
    /// @notice USDC token
    ...
    /// @notice User: Balaji
    ChainSettleUser internal USER_BALAJI;
    /// @notice User: Counterparty
    ChainSettleUser internal USER_COUNTERPARTY;
    ...
    function setUp() public {
        ...
        // Setup users
        USER_BALAJI = new ChainSettleUser(USDC_TOKEN, WBTC_TOKEN, BET_CONTRACT);
        USER_COUNTERPARTY = new ChainSettleUser(USDC_TOKEN, WBTC_TOKEN, BET_CONTRACT);
